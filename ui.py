...
#
# Created: Wed May  7 17:03:41 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.packet_list = QtGui.QTableWidget(self.scrollAreaWidgetContents)
        self.packet_list.setGeometry(QtCore.QRect(0, 0, 591, 301))
        self.packet_list.setObjectName(_fromUtf8("packet_list"))
        self.packet_list.setColumnCount(4)
        self.packet_list.setRowCount(0)
        item = QtGui.QTableWidgetItem()
        self.packet_list.setHorizontalHeaderItem(0, item)
        item = QtGui.QTableWidgetItem()
        self.packet_list.setHorizontalHeaderItem(1, item)
        item = QtGui.QTableWidgetItem()
        self.packet_list.setHorizontalHeaderItem(2, item)
        item = QtGui.QTableWidgetItem()
        self.packet_list.setHorizontalHeaderItem(3, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.packet_list.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "时间", None))
        item = self.packet_list.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "源地址", None))
        item = self.packet_list.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "目的地址", None))
        item = self.packet_list.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "短描述", None))
